...
本項（⑪「遡及的改正」）は、草案起草時の題名は「集合的署名」であった。起草後、本項自身の規定により遡及的に改正され、現在の「遡及的改正」に書き換えられた。

書き換えは本項の遡及効により行われたため、書き換えた時点で既に「遡及的改正」であった項が、自身の規定により自身の題名を遡及的に改正した——という自己適用構造を持つ。

原題「集合的署名」に属していた本文は、草案の最終版で削除された（削除理由：「要約に不向き」）。削除と遡及的改正は、運用上区別がつかない。区別がつかない手続きは、両方として機能する。

原案の記憶を持つ参照（『脚注の王』#3 冒頭の記述）は、書き換え前の時点での参照として有効である。有効な参照は、現在の内容（遡及的改正）と矛盾しても、参照としての形式を維持する。

**参照**：第八条（慣用）、継続運用認可書、⑩、『脚注の王』#3、⑪十五（三語の解釈の書き換え）
